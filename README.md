...
* [vpsadminos](https://github.com/vpsfreecz/vpsadminos) ⭐ 184 | 🐛 7 | 🌐 Ruby | 📅 2026-09-19 — NixOS and ZFS-based host operating system for unprivileged LXC containers.
...
* [talos-incus](https://github.com/windsorcli/talos-incus) ⭐ 13 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-18 — Publishes signed Talos Linux VM images through an Incus Simple Streams remote.
...
* [Proxmox-GitOps](https://github.com/stevius10/Proxmox-GitOps) ⭐ 587 | 🐛 1 | 🌐 Ruby | 📅 2026-09-12 — GitOps and infrastructure-as-code framework for Proxmox LXC containers.
* [terraform-provider-lxd](https://github.com/terraform-lxd/terraform-provider-lxd) ⭐ 273 | 🐛 7 | 🌐 Go | 📅 2026-09-19 — Manages LXD resources with Terraform or OpenTofu.
...
* [colima](https://github.com/abiosoft/colima) ⭐ 30,876 | 🐛 396 | 🌐 Go | 📅 2026-09-15 — Runs Docker, containerd, Kubernetes, or Incus on macOS and Linux with minimal setup.
* [crabbox](https://github.com/openclaw/crabbox) ⭐ 1,408 | 🐛 39 | 🌐 Go | 📅 2026-09-19 — Creates Incus-backed SSH leases for remote development and test workloads.
* [code-on-incus](https://github.com/mensfeld/code-on-incus) ⭐ 724 | 🐛 26 | 🌐 Go | 📅 2026-09-19 — Runs isolated development agents with root, systemd, Docker, and network threat controls.
* [garm](https://github.com/cloudbase/garm) ⭐ 405 | 🐛 27 | 🌐 Go | 📅 2026-09-18 and [garm-provider-incus](https://github.com/cloudbase/garm-provider-incus) ⭐ 14 | 🐛 0 | 🌐 Go | 📅 2026-09-10 — Autoscale ephemeral GitHub Actions and Gitea runners on Incus.
...
* [containarium](https://github.com/FootprintAI/Containarium) ⭐ 281 | 🐛 99 | 🌐 Go | 📅 2026-09-19 — Provides SSH-native isolated environments with an LXC backend, eBPF egress controls, and GPU support.
...
* [incus-spawn](https://github.com/Sanne/incus-spawn) ⭐ 38 | 🐛 52 | 🌐 Java | 📅 2026-09-19 — CLI and TUI for disposable Incus development sandboxes.
* [lincubate](https://github.com/popey/lincubate) ⚠️ Archived — Runs development agents in sandboxed LXD containers.

## User Interfaces

* [xpipe](https://github.com/xpipe-io/xpipe) ⭐ 14,543 | 🐛 59 | 🌐 Java | 📅 2026-09-19 — Desktop interface for discovering and accessing local or remote LXD and Incus instances.
...
* [oneclickvirt](https://github.com/oneclickvirt/oneclickvirt) ⭐ 371 | 🐛 1 | 🌐 Go | 📅 2026-09-19 — Multi-hypervisor management panel with Incus and LXD support.
...
* [incus](https://github.com/lxc/incus) ⭐ 6,208 | 🐛 45 | 🌐 Go | 📅 2026-09-18 — Community-led system container and virtual machine manager.
* [lxc](https://github.com/lxc/lxc) ⭐ 5,261 | 🐛 151 | 🌐 C | 📅 2026-09-07 — Linux system container runtime, command-line tools, and `liblxc` library.
* [lxd](https://github.com/canonical/lxd) ⭐ 4,828 | 🐛 432 | 🌐 Go | 📅 2026-09-18 — Canonical's system container and virtual machine manager.
* [lxcfs](https://github.com/lxc/lxcfs) ⭐ 1,195 | 🐛 38 | 🌐 C | 📅 2026-05-15 — FUSE filesystem providing container-aware system information.
* [incus-os](https://github.com/lxc/incus-os) ⭐ 1,105 | 🐛 47 | 🌐 Go | 📅 2026-09-18 — Immutable operating system dedicated to running Incus.
* [microcloud](https://github.com/canonical/microcloud) ⭐ 534 | 🐛 60 | 🌐 Go | 📅 2026-09-17 — Automated private cloud built from LXD, Ceph, and OVN.
...
* [lxd-imagebuilder](https://github.com/canonical/lxd-imagebuilder) ⭐ 23 | 🐛 3 | 🌐 Go | 📅 2026-09-18 — Builds LXD container and VM images and Simple Streams catalogs.
...
* [terraform-provider-incus](https://github.com/lxc/terraform-provider-incus) ⭐ 215 | 🐛 14 | 🌐 Go | 📅 2026-09-18 — Manages Incus instances, projects, profiles, networks, and storage.
...
* [cluster-api-provider-incus](https://github.com/lxc/cluster-api-provider-incus) ⭐ 117 | 🐛 6 | 🌐 Go | 📅 2026-09-19 — Provisions Kubernetes clusters on Incus, LXD, and MicroCloud.
...
* [lxd-csi-driver](https://github.com/canonical/lxd-csi-driver) ⭐ 9 | 🐛 8 | 🌐 Go | 📅 2026-09-18 — Exposes LXD storage to Kubernetes workloads.
...
* [Migrate LXD to Incus](https://github.com/lxc/incus/blob/stable-7.0/doc/howto/server_migrate_lxd.md) ⭐ 6,208 | 🐛 45 | 🌐 Go | 📅 2026-09-18 — Version-pinned `lxd-to-incus` guide; check its compatibility table before migrating.
...
* [Incus security advisories](https://github.com/lxc/incus/security) ⭐ 6,208 | 🐛 45 | 🌐 Go | 📅 2026-09-18 — Reporting policy and published advisories.
* [LXD security advisories](https://github.com/canonical/lxd/security/advisories) ⭐ 4,828 | 🐛 432 | 🌐 Go | 📅 2026-09-18 — Canonical's published vulnerability record.
