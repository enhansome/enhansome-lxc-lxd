...
* [zabbly/incus](https://github.com/zabbly/incus) ⭐ 540 | 🐛 6 | 🌐 Python | 📅 2026-08-16 — Signed Incus packages for supported Debian and Ubuntu releases.
* [vpsadminos](https://github.com/vpsfreecz/vpsadminos) ⭐ 184 | 🐛 6 | 🌐 Ruby | 📅 2026-08-24 — NixOS and ZFS-based host operating system for unprivileged LXC containers.
...
* [Proxmox-GitOps](https://github.com/stevius10/Proxmox-GitOps) ⭐ 579 | 🐛 1 | 🌐 Ruby | 📅 2026-07-18 — GitOps and infrastructure-as-code framework for Proxmox LXC containers.
* [terraform-provider-lxd](https://github.com/terraform-lxd/terraform-provider-lxd) ⭐ 273 | 🐛 10 | 🌐 Go | 📅 2026-08-24 — Manages LXD resources with Terraform or OpenTofu.
...
* [colima](https://github.com/abiosoft/colima) ⭐ 30,495 | 🐛 388 | 🌐 Go | 📅 2026-08-17 — Runs Docker, containerd, Kubernetes, or Incus on macOS and Linux with minimal setup.
* [crabbox](https://github.com/openclaw/crabbox) ⭐ 1,331 | 🐛 27 | 🌐 Go | 📅 2026-08-24 — Creates Incus-backed SSH leases for remote development and test workloads.
* [code-on-incus](https://github.com/mensfeld/code-on-incus) ⭐ 664 | 🐛 32 | 🌐 Go | 📅 2026-08-24 — Runs isolated development agents with root, systemd, Docker, and network threat controls.
* [garm](https://github.com/cloudbase/garm) ⭐ 384 | 🐛 26 | 🌐 Go | 📅 2026-08-24 and [garm-provider-incus](https://github.com/cloudbase/garm-provider-incus) ⭐ 14 | 🐛 0 | 🌐 Go | 📅 2026-08-20 — Autoscale ephemeral GitHub Actions and Gitea runners on Incus.
...
* [containarium](https://github.com/FootprintAI/Containarium) ⭐ 274 | 🐛 92 | 🌐 Go | 📅 2026-08-24 — Provides SSH-native isolated environments with an LXC backend, eBPF egress controls, and GPU support.
...
* [incus-spawn](https://github.com/Sanne/incus-spawn) ⭐ 34 | 🐛 42 | 🌐 Java | 📅 2026-08-23 — CLI and TUI for disposable Incus development sandboxes.
* [lincubate](https://github.com/popey/lincubate) ⚠️ Archived — Runs development agents in sandboxed LXD containers.

## User Interfaces

* [xpipe](https://github.com/xpipe-io/xpipe) ⭐ 14,456 | 🐛 65 | 🌐 Java | 📅 2026-08-24 — Desktop interface for discovering and accessing local or remote LXD and Incus instances.
...
* [incus-ui-canonical](https://github.com/zabbly/incus-ui-canonical) ⭐ 112 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-23 — Frequently rebased Incus-compatible fork of Canonical's LXD UI.
...
* [kapsule](https://github.com/KDE/kapsule) ⭐ 22 | 🐛 0 | 🌐 Python | 📅 2026-08-24 — Incus container management with KDE Plasma integration.
...
* [incus](https://github.com/lxc/incus) ⭐ 6,009 | 🐛 38 | 🌐 Go | 📅 2026-08-24 — Community-led system container and virtual machine manager.
* [lxc](https://github.com/lxc/lxc) ⭐ 5,247 | 🐛 149 | 🌐 C | 📅 2026-08-20 — Linux system container runtime, command-line tools, and `liblxc` library.
* [lxd](https://github.com/canonical/lxd) ⭐ 4,815 | 🐛 414 | 🌐 Go | 📅 2026-08-24 — Canonical's system container and virtual machine manager.
* [lxcfs](https://github.com/lxc/lxcfs) ⭐ 1,193 | 🐛 37 | 🌐 C | 📅 2026-05-15 — FUSE filesystem providing container-aware system information.
* [incus-os](https://github.com/lxc/incus-os) ⭐ 1,082 | 🐛 57 | 🌐 Go | 📅 2026-08-22 — Immutable operating system dedicated to running Incus.
* [microcloud](https://github.com/canonical/microcloud) ⭐ 526 | 🐛 52 | 🌐 Go | 📅 2026-08-24 — Automated private cloud built from LXD, Ceph, and OVN.
...
* [lxd-ui](https://github.com/canonical/lxd-ui) ⭐ 492 | 🐛 42 | 🌐 TypeScript | 📅 2026-08-24 — Canonical's official browser interface, included with LXD.
* [go-lxc](https://github.com/lxc/go-lxc) ⭐ 467 | 🐛 5 | 🌐 Go | 📅 2026-03-16 — Go bindings for `liblxc`.
* [pylxd](https://github.com/canonical/pylxd) ⭐ 277 | 🐛 46 | 🌐 Python | 📅 2026-08-18 — Official Python client for the LXD REST API.
* [terraform-provider-incus](https://github.com/lxc/terraform-provider-incus) ⭐ 209 | 🐛 15 | 🌐 Go | 📅 2026-08-24 — Manages Incus instances, projects, profiles, networks, and storage.
...
* [incus-compose](https://github.com/lxc/incus-compose) ⭐ 56 | 🐛 9 | 🌐 Go | 📅 2026-08-24 — Runs Compose-spec workloads natively on Incus.
...
* [Migrate LXD to Incus](https://github.com/lxc/incus/blob/stable-7.0/doc/howto/server_migrate_lxd.md) ⭐ 6,009 | 🐛 38 | 🌐 Go | 📅 2026-08-24 — Version-pinned `lxd-to-incus` guide; check its compatibility table before migrating.
...
* [Incus security advisories](https://github.com/lxc/incus/security) ⭐ 6,009 | 🐛 38 | 🌐 Go | 📅 2026-08-24 — Reporting policy and published advisories.
* [LXD security advisories](https://github.com/canonical/lxd/security/advisories) ⭐ 4,815 | 🐛 414 | 🌐 Go | 📅 2026-08-24 — Canonical's published vulnerability record.
