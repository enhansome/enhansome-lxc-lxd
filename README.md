...
* [zabbly/incus](https://github.com/zabbly/incus) ⭐ 554 | 🐛 6 | 🌐 Python | 📅 2026-09-14 — Signed Incus packages for supported Debian and Ubuntu releases.
* [vpsadminos](https://github.com/vpsfreecz/vpsadminos) ⭐ 184 | 🐛 7 | 🌐 Ruby | 📅 2026-09-18 — NixOS and ZFS-based host operating system for unprivileged LXC containers.
...
* [incus-windows](https://github.com/antifob/incus-windows) ⭐ 103 | 🐛 2 | 🌐 PowerShell | 📅 2026-09-05 — Toolset for creating Windows images for Incus virtual machines.
...
* [talos-incus](https://github.com/windsorcli/talos-incus) ⭐ 13 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-15 — Publishes signed Talos Linux VM images through an Incus Simple Streams remote.
* [Ubuntu Cloud Images](https://cloud-images.ubuntu.com/releases/) — Official stable Ubuntu images used by the `ubuntu:` remote.

## Libraries and SDKs

* [lxc-rs](https://github.com/sanpii/lxc-rs) ⭐ 24 | 🐛 8 | 🌐 Rust | 📅 2026-09-08 — Rust bindings for the native `liblxc` API.
...
* [Proxmox-GitOps](https://github.com/stevius10/Proxmox-GitOps) ⭐ 586 | 🐛 1 | 🌐 Ruby | 📅 2026-09-12 — GitOps and infrastructure-as-code framework for Proxmox LXC containers.
* [terraform-provider-lxd](https://github.com/terraform-lxd/terraform-provider-lxd) ⭐ 273 | 🐛 6 | 🌐 Go | 📅 2026-09-16 — Manages LXD resources with Terraform or OpenTofu.
* [proxmox-lxc-autoscale](https://github.com/fabriziosalmi/proxmox-lxc-autoscale) ⭐ 260 | 🐛 15 | 🌐 Python | 📅 2026-09-07 — Dynamically adjusts CPU and memory allocations for Proxmox LXC containers.
* [incus-apply](https://github.com/abiosoft/incus-apply) ⭐ 35 | 🐛 7 | 🌐 Go | 📅 2026-06-15 — Declarative configuration management for Incus resources.
...
* [colima](https://github.com/abiosoft/colima) ⭐ 30,863 | 🐛 396 | 🌐 Go | 📅 2026-09-15 — Runs Docker, containerd, Kubernetes, or Incus on macOS and Linux with minimal setup.
* [crabbox](https://github.com/openclaw/crabbox) ⭐ 1,404 | 🐛 41 | 🌐 Go | 📅 2026-09-18 — Creates Incus-backed SSH leases for remote development and test workloads.
* [code-on-incus](https://github.com/mensfeld/code-on-incus) ⭐ 722 | 🐛 23 | 🌐 Go | 📅 2026-09-15 — Runs isolated development agents with root, systemd, Docker, and network threat controls.
* [garm](https://github.com/cloudbase/garm) ⭐ 405 | 🐛 26 | 🌐 Go | 📅 2026-09-18 and [garm-provider-incus](https://github.com/cloudbase/garm-provider-incus) ⭐ 14 | 🐛 0 | 🌐 Go | 📅 2026-09-10 — Autoscale ephemeral GitHub Actions and Gitea runners on Incus.
...
* [containarium](https://github.com/FootprintAI/Containarium) ⭐ 281 | 🐛 75 | 🌐 Go | 📅 2026-09-18 — Provides SSH-native isolated environments with an LXC backend, eBPF egress controls, and GPU support.
...
* [vibebin](https://github.com/jgbrwn/vibebin) ⭐ 107 | 🐛 0 | 🌐 Go | 📅 2026-08-10 — Creates Incus-backed coding and hosting environments on self-hosted servers.
* [incant](https://github.com/lnussbaum/incant) ⭐ 87 | 🐛 8 | 🌐 Python | 📅 2026-07-20 — Defines reproducible Incus development environments in YAML.
...
* [incus-spawn](https://github.com/Sanne/incus-spawn) ⭐ 38 | 🐛 53 | 🌐 Java | 📅 2026-09-18 — CLI and TUI for disposable Incus development sandboxes.
* [lincubate](https://github.com/popey/lincubate) ⚠️ Archived — Runs development agents in sandboxed LXD containers.

## User Interfaces

* [xpipe](https://github.com/xpipe-io/xpipe) ⭐ 14,542 | 🐛 60 | 🌐 Java | 📅 2026-09-17 — Desktop interface for discovering and accessing local or remote LXD and Incus instances.
* [LxdMosaic](https://github.com/turtle0x1/LxdMosaic) ⭐ 615 | 🐛 21 | 🌐 PHP | 📅 2026-09-03 — Web interface for managing multiple LXD and Incus servers.
...
* [oneclickvirt](https://github.com/oneclickvirt/oneclickvirt) ⭐ 371 | 🐛 1 | 🌐 Go | 📅 2026-09-13 — Multi-hypervisor management panel with Incus and LXD support.
* [incus-ui-canonical](https://github.com/zabbly/incus-ui-canonical) ⭐ 118 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-15 — Frequently rebased Incus-compatible fork of Canonical's LXD UI.
* [ararat-web](https://github.com/hyecompany/ararat-web) ⭐ 42 | 🐛 19 | 🌐 TypeScript | 📅 2026-07-25 — Incus-native web control plane currently in public beta.
* [kapsule](https://github.com/KDE/kapsule) ⭐ 23 | 🐛 0 | 🌐 Python | 📅 2026-08-31 — Incus container management with KDE Plasma integration.

## Operations

* [incusAutobackup](https://github.com/rbnhln/incusAutobackup) ⭐ 8 | 🐛 13 | 🌐 Go | 📅 2026-09-08 — Replicates Incus instances and volumes between source and target hosts.
...
* [incus](https://github.com/lxc/incus) ⭐ 6,200 | 🐛 45 | 🌐 Go | 📅 2026-09-18 — Community-led system container and virtual machine manager.
* [lxc](https://github.com/lxc/lxc) ⭐ 5,261 | 🐛 151 | 🌐 C | 📅 2026-09-07 — Linux system container runtime, command-line tools, and `liblxc` library.
* [lxd](https://github.com/canonical/lxd) ⭐ 4,827 | 🐛 427 | 🌐 Go | 📅 2026-09-17 — Canonical's system container and virtual machine manager.
* [lxcfs](https://github.com/lxc/lxcfs) ⭐ 1,195 | 🐛 38 | 🌐 C | 📅 2026-05-15 — FUSE filesystem providing container-aware system information.
* [incus-os](https://github.com/lxc/incus-os) ⭐ 1,105 | 🐛 46 | 🌐 Go | 📅 2026-09-18 — Immutable operating system dedicated to running Incus.
* [microcloud](https://github.com/canonical/microcloud) ⭐ 534 | 🐛 59 | 🌐 Go | 📅 2026-09-17 — Automated private cloud built from LXD, Ceph, and OVN.
...
* [distrobuilder](https://github.com/lxc/distrobuilder) ⭐ 873 | 🐛 27 | 🌐 Go | 📅 2026-09-01 — Builds LXC and Incus images from declarative YAML definitions.
* [lxd-imagebuilder](https://github.com/canonical/lxd-imagebuilder) ⭐ 23 | 🐛 1 | 🌐 Go | 📅 2026-09-15 — Builds LXD container and VM images and Simple Streams catalogs.
...
* [lxd-ui](https://github.com/canonical/lxd-ui) ⭐ 495 | 🐛 43 | 🌐 TypeScript | 📅 2026-09-18 — Canonical's official browser interface, included with LXD.
* [go-lxc](https://github.com/lxc/go-lxc) ⭐ 468 | 🐛 6 | 🌐 Go | 📅 2026-03-16 — Go bindings for `liblxc`.
* [pylxd](https://github.com/canonical/pylxd) ⭐ 277 | 🐛 46 | 🌐 Python | 📅 2026-09-08 — Official Python client for the LXD REST API.
* [terraform-provider-incus](https://github.com/lxc/terraform-provider-incus) ⭐ 215 | 🐛 13 | 🌐 Go | 📅 2026-09-14 — Manages Incus instances, projects, profiles, networks, and storage.
...
* [cluster-api-provider-incus](https://github.com/lxc/cluster-api-provider-incus) ⭐ 117 | 🐛 6 | 🌐 Go | 📅 2026-09-18 — Provisions Kubernetes clusters on Incus, LXD, and MicroCloud.
* [incus-compose](https://github.com/lxc/incus-compose) ⭐ 79 | 🐛 5 | 🌐 Go | 📅 2026-09-17 — Runs Compose-spec workloads natively on Incus.
* [python3-lxc](https://github.com/lxc/python3-lxc) ⭐ 68 | 🐛 9 | 🌐 C | 📅 2026-08-20 — Python 3 bindings for `liblxc`.
* [lxd-csi-driver](https://github.com/canonical/lxd-csi-driver) ⭐ 9 | 🐛 10 | 🌐 Go | 📅 2026-09-18 — Exposes LXD storage to Kubernetes workloads.
...
* [Migrate LXD to Incus](https://github.com/lxc/incus/blob/stable-7.0/doc/howto/server_migrate_lxd.md) ⭐ 6,200 | 🐛 45 | 🌐 Go | 📅 2026-09-18 — Version-pinned `lxd-to-incus` guide; check its compatibility table before migrating.
...
* [Incus security advisories](https://github.com/lxc/incus/security) ⭐ 6,200 | 🐛 45 | 🌐 Go | 📅 2026-09-18 — Reporting policy and published advisories.
* [LXD security advisories](https://github.com/canonical/lxd/security/advisories) ⭐ 4,827 | 🐛 427 | 🌐 Go | 📅 2026-09-17 — Canonical's published vulnerability record.
