...
* [vpsadminos](https://github.com/vpsfreecz/vpsadminos) ⭐ 184 | 🐛 7 | 🌐 Ruby | 📅 2026-09-21 — NixOS and ZFS-based host operating system for unprivileged LXC containers.
...
* [colima](https://github.com/abiosoft/colima) ⭐ 30,913 | 🐛 395 | 🌐 Go | 📅 2026-09-19 — Runs Docker, containerd, Kubernetes, or Incus on macOS and Linux with minimal setup.
* [crabbox](https://github.com/openclaw/crabbox) ⭐ 1,413 | 🐛 31 | 🌐 Go | 📅 2026-09-21 — Creates Incus-backed SSH leases for remote development and test workloads.
* [code-on-incus](https://github.com/mensfeld/code-on-incus) ⭐ 727 | 🐛 23 | 🌐 Go | 📅 2026-09-20 — Runs isolated development agents with root, systemd, Docker, and network threat controls.
* [garm](https://github.com/cloudbase/garm) ⭐ 405 | 🐛 21 | 🌐 Go | 📅 2026-09-21 and [garm-provider-incus](https://github.com/cloudbase/garm-provider-incus) ⭐ 14 | 🐛 0 | 🌐 Go | 📅 2026-09-10 — Autoscale ephemeral GitHub Actions and Gitea runners on Incus.
...
* [containarium](https://github.com/FootprintAI/Containarium) ⭐ 282 | 🐛 73 | 🌐 Go | 📅 2026-09-21 — Provides SSH-native isolated environments with an LXC backend, eBPF egress controls, and GPU support.
...
* [incus-spawn](https://github.com/Sanne/incus-spawn) ⭐ 38 | 🐛 55 | 🌐 Java | 📅 2026-09-21 — CLI and TUI for disposable Incus development sandboxes.
* [lincubate](https://github.com/popey/lincubate) ⚠️ Archived — Runs development agents in sandboxed LXD containers.

## User Interfaces

* [xpipe](https://github.com/xpipe-io/xpipe) ⭐ 14,547 | 🐛 59 | 🌐 Java | 📅 2026-09-20 — Desktop interface for discovering and accessing local or remote LXD and Incus instances.
...
* [oneclickvirt](https://github.com/oneclickvirt/oneclickvirt) ⭐ 371 | 🐛 1 | 🌐 Go | 📅 2026-09-21 — Multi-hypervisor management panel with Incus and LXD support.
...
* [incus](https://github.com/lxc/incus) ⭐ 6,220 | 🐛 48 | 🌐 Go | 📅 2026-09-21 — Community-led system container and virtual machine manager.
* [lxc](https://github.com/lxc/lxc) ⭐ 5,263 | 🐛 151 | 🌐 C | 📅 2026-09-07 — Linux system container runtime, command-line tools, and `liblxc` library.
* [lxd](https://github.com/canonical/lxd) ⭐ 4,832 | 🐛 434 | 🌐 Go | 📅 2026-09-21 — Canonical's system container and virtual machine manager.
* [lxcfs](https://github.com/lxc/lxcfs) ⭐ 1,196 | 🐛 38 | 🌐 C | 📅 2026-05-15 — FUSE filesystem providing container-aware system information.
* [incus-os](https://github.com/lxc/incus-os) ⭐ 1,110 | 🐛 48 | 🌐 Go | 📅 2026-09-18 — Immutable operating system dedicated to running Incus.
...
* [lxd-ui](https://github.com/canonical/lxd-ui) ⭐ 495 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-21 — Canonical's official browser interface, included with LXD.
* [go-lxc](https://github.com/lxc/go-lxc) ⭐ 468 | 🐛 6 | 🌐 Go | 📅 2026-03-16 — Go bindings for `liblxc`.
* [pylxd](https://github.com/canonical/pylxd) ⭐ 277 | 🐛 47 | 🌐 Python | 📅 2026-09-21 — Official Python client for the LXD REST API.
* [terraform-provider-incus](https://github.com/lxc/terraform-provider-incus) ⭐ 215 | 🐛 12 | 🌐 Go | 📅 2026-09-19 — Manages Incus instances, projects, profiles, networks, and storage.
...
* [cluster-api-provider-incus](https://github.com/lxc/cluster-api-provider-incus) ⭐ 119 | 🐛 6 | 🌐 Go | 📅 2026-09-19 — Provisions Kubernetes clusters on Incus, LXD, and MicroCloud.
* [incus-compose](https://github.com/lxc/incus-compose) ⭐ 80 | 🐛 6 | 🌐 Go | 📅 2026-09-17 — Runs Compose-spec workloads natively on Incus.
...
* [Migrate LXD to Incus](https://github.com/lxc/incus/blob/stable-7.0/doc/howto/server_migrate_lxd.md) ⭐ 6,220 | 🐛 48 | 🌐 Go | 📅 2026-09-21 — Version-pinned `lxd-to-incus` guide; check its compatibility table before migrating.
...
* [Incus security advisories](https://github.com/lxc/incus/security) ⭐ 6,220 | 🐛 48 | 🌐 Go | 📅 2026-09-21 — Reporting policy and published advisories.
* [LXD security advisories](https://github.com/canonical/lxd/security/advisories) ⭐ 4,832 | 🐛 434 | 🌐 Go | 📅 2026-09-21 — Canonical's published vulnerability record.
