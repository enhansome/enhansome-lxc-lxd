...
* [zabbly/incus](https://github.com/zabbly/incus) ⭐ 552 | 🐛 6 | 🌐 Python | 📅 2026-09-07 — Signed Incus packages for supported Debian and Ubuntu releases.
* [vpsadminos](https://github.com/vpsfreecz/vpsadminos) ⭐ 184 | 🐛 6 | 🌐 Ruby | 📅 2026-09-13 — NixOS and ZFS-based host operating system for unprivileged LXC containers.
...
* [terraform-provider-lxd](https://github.com/terraform-lxd/terraform-provider-lxd) ⭐ 273 | 🐛 8 | 🌐 Go | 📅 2026-09-12 — Manages LXD resources with Terraform or OpenTofu.
...
* [colima](https://github.com/abiosoft/colima) ⭐ 30,785 | 🐛 396 | 🌐 Go | 📅 2026-09-11 — Runs Docker, containerd, Kubernetes, or Incus on macOS and Linux with minimal setup.
* [crabbox](https://github.com/openclaw/crabbox) ⭐ 1,392 | 🐛 38 | 🌐 Go | 📅 2026-09-13 — Creates Incus-backed SSH leases for remote development and test workloads.
* [code-on-incus](https://github.com/mensfeld/code-on-incus) ⭐ 702 | 🐛 25 | 🌐 Go | 📅 2026-09-13 — Runs isolated development agents with root, systemd, Docker, and network threat controls.
* [garm](https://github.com/cloudbase/garm) ⭐ 402 | 🐛 22 | 🌐 Go | 📅 2026-09-12 and [garm-provider-incus](https://github.com/cloudbase/garm-provider-incus) ⭐ 14 | 🐛 0 | 🌐 Go | 📅 2026-09-10 — Autoscale ephemeral GitHub Actions and Gitea runners on Incus.
...
* [containarium](https://github.com/FootprintAI/Containarium) ⭐ 277 | 🐛 92 | 🌐 Go | 📅 2026-09-13 — Provides SSH-native isolated environments with an LXC backend, eBPF egress controls, and GPU support.
...
* [incus-spawn](https://github.com/Sanne/incus-spawn) ⭐ 38 | 🐛 51 | 🌐 Java | 📅 2026-09-12 — CLI and TUI for disposable Incus development sandboxes.
* [lincubate](https://github.com/popey/lincubate) ⚠️ Archived — Runs development agents in sandboxed LXD containers.

## User Interfaces

* [xpipe](https://github.com/xpipe-io/xpipe) ⭐ 14,529 | 🐛 59 | 🌐 Java | 📅 2026-09-13 — Desktop interface for discovering and accessing local or remote LXD and Incus instances.
...
* [incus](https://github.com/lxc/incus) ⭐ 6,171 | 🐛 48 | 🌐 Go | 📅 2026-09-13 — Community-led system container and virtual machine manager.
* [lxc](https://github.com/lxc/lxc) ⭐ 5,261 | 🐛 148 | 🌐 C | 📅 2026-09-07 — Linux system container runtime, command-line tools, and `liblxc` library.
* [lxd](https://github.com/canonical/lxd) ⭐ 4,826 | 🐛 415 | 🌐 Go | 📅 2026-09-12 — Canonical's system container and virtual machine manager.
* [lxcfs](https://github.com/lxc/lxcfs) ⭐ 1,194 | 🐛 38 | 🌐 C | 📅 2026-05-15 — FUSE filesystem providing container-aware system information.
* [incus-os](https://github.com/lxc/incus-os) ⭐ 1,099 | 🐛 45 | 🌐 Go | 📅 2026-09-13 — Immutable operating system dedicated to running Incus.
* [microcloud](https://github.com/canonical/microcloud) ⭐ 532 | 🐛 59 | 🌐 Go | 📅 2026-09-11 — Automated private cloud built from LXD, Ceph, and OVN.
...
* [distrobuilder](https://github.com/lxc/distrobuilder) ⭐ 871 | 🐛 27 | 🌐 Go | 📅 2026-09-01 — Builds LXC and Incus images from declarative YAML definitions.
...
* [lxd-ui](https://github.com/canonical/lxd-ui) ⭐ 495 | 🐛 41 | 🌐 TypeScript | 📅 2026-09-11 — Canonical's official browser interface, included with LXD.
...
* [terraform-provider-incus](https://github.com/lxc/terraform-provider-incus) ⭐ 213 | 🐛 13 | 🌐 Go | 📅 2026-08-31 — Manages Incus instances, projects, profiles, networks, and storage.
...
* [incus-compose](https://github.com/lxc/incus-compose) ⭐ 78 | 🐛 8 | 🌐 Go | 📅 2026-09-13 — Runs Compose-spec workloads natively on Incus.
...
* [Migrate LXD to Incus](https://github.com/lxc/incus/blob/stable-7.0/doc/howto/server_migrate_lxd.md) ⭐ 6,171 | 🐛 48 | 🌐 Go | 📅 2026-09-13 — Version-pinned `lxd-to-incus` guide; check its compatibility table before migrating.
...
* [Incus security advisories](https://github.com/lxc/incus/security) ⭐ 6,171 | 🐛 48 | 🌐 Go | 📅 2026-09-13 — Reporting policy and published advisories.
* [LXD security advisories](https://github.com/canonical/lxd/security/advisories) ⭐ 4,826 | 🐛 415 | 🌐 Go | 📅 2026-09-12 — Canonical's published vulnerability record.
