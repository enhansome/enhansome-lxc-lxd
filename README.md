...
* [zabbly/incus](https://github.com/zabbly/incus) ⭐ 544 | 🐛 6 | 🌐 Python | 📅 2026-08-31 — Signed Incus packages for supported Debian and Ubuntu releases.
* [vpsadminos](https://github.com/vpsfreecz/vpsadminos) ⭐ 184 | 🐛 6 | 🌐 Ruby | 📅 2026-08-31 — NixOS and ZFS-based host operating system for unprivileged LXC containers.
* [incus-docker](https://github.com/cmspam/incus-docker) ⭐ 52 | 🐛 1 | 🌐 Dockerfile | 📅 2026-08-10 — Runs Incus and its web UI inside privileged Docker or Podman containers.
...
* [colima](https://github.com/abiosoft/colima) ⭐ 30,574 | 🐛 390 | 🌐 Go | 📅 2026-08-24 — Runs Docker, containerd, Kubernetes, or Incus on macOS and Linux with minimal setup.
* [crabbox](https://github.com/openclaw/crabbox) ⭐ 1,347 | 🐛 39 | 🌐 Go | 📅 2026-08-31 — Creates Incus-backed SSH leases for remote development and test workloads.
* [code-on-incus](https://github.com/mensfeld/code-on-incus) ⭐ 679 | 🐛 27 | 🌐 Go | 📅 2026-08-31 — Runs isolated development agents with root, systemd, Docker, and network threat controls.
* [garm](https://github.com/cloudbase/garm) ⭐ 389 | 🐛 29 | 🌐 Go | 📅 2026-08-25 and [garm-provider-incus](https://github.com/cloudbase/garm-provider-incus) ⭐ 14 | 🐛 0 | 🌐 Go | 📅 2026-08-29 — Autoscale ephemeral GitHub Actions and Gitea runners on Incus.
...
* [containarium](https://github.com/FootprintAI/Containarium) ⭐ 276 | 🐛 102 | 🌐 Go | 📅 2026-08-31 — Provides SSH-native isolated environments with an LXC backend, eBPF egress controls, and GPU support.
...
* [incus-spawn](https://github.com/Sanne/incus-spawn) ⭐ 36 | 🐛 46 | 🌐 Java | 📅 2026-08-30 — CLI and TUI for disposable Incus development sandboxes.
* [lincubate](https://github.com/popey/lincubate) ⚠️ Archived — Runs development agents in sandboxed LXD containers.

## User Interfaces

* [xpipe](https://github.com/xpipe-io/xpipe) ⭐ 14,476 | 🐛 68 | 🌐 Java | 📅 2026-08-31 — Desktop interface for discovering and accessing local or remote LXD and Incus instances.
...
* [oneclickvirt](https://github.com/oneclickvirt/oneclickvirt) ⭐ 366 | 🐛 1 | 🌐 Go | 📅 2026-08-30 — Multi-hypervisor management panel with Incus and LXD support.
...
* [incus](https://github.com/lxc/incus) ⭐ 6,098 | 🐛 34 | 🌐 Go | 📅 2026-08-31 — Community-led system container and virtual machine manager.
* [lxc](https://github.com/lxc/lxc) ⭐ 5,251 | 🐛 149 | 🌐 C | 📅 2026-08-31 — Linux system container runtime, command-line tools, and `liblxc` library.
* [lxd](https://github.com/canonical/lxd) ⭐ 4,821 | 🐛 423 | 🌐 Go | 📅 2026-08-31 — Canonical's system container and virtual machine manager.
* [lxcfs](https://github.com/lxc/lxcfs) ⭐ 1,194 | 🐛 37 | 🌐 C | 📅 2026-05-15 — FUSE filesystem providing container-aware system information.
* [incus-os](https://github.com/lxc/incus-os) ⭐ 1,088 | 🐛 44 | 🌐 Go | 📅 2026-08-29 — Immutable operating system dedicated to running Incus.
...
* [distrobuilder](https://github.com/lxc/distrobuilder) ⭐ 868 | 🐛 27 | 🌐 Go | 📅 2026-08-26 — Builds LXC and Incus images from declarative YAML definitions.
...
* [lxd-ui](https://github.com/canonical/lxd-ui) ⭐ 493 | 🐛 42 | 🌐 TypeScript | 📅 2026-08-31 — Canonical's official browser interface, included with LXD.
...
* [incus-compose](https://github.com/lxc/incus-compose) ⭐ 65 | 🐛 7 | 🌐 Go | 📅 2026-08-31 — Runs Compose-spec workloads natively on Incus.
...
* [Migrate LXD to Incus](https://github.com/lxc/incus/blob/stable-7.0/doc/howto/server_migrate_lxd.md) ⭐ 6,098 | 🐛 34 | 🌐 Go | 📅 2026-08-31 — Version-pinned `lxd-to-incus` guide; check its compatibility table before migrating.
...
* [Incus security advisories](https://github.com/lxc/incus/security) ⭐ 6,098 | 🐛 34 | 🌐 Go | 📅 2026-08-31 — Reporting policy and published advisories.
* [LXD security advisories](https://github.com/canonical/lxd/security/advisories) ⭐ 4,821 | 🐛 423 | 🌐 Go | 📅 2026-08-31 — Canonical's published vulnerability record.
