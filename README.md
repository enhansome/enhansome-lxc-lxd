...
* [vpsadminos](https://github.com/vpsfreecz/vpsadminos) ⭐ 184 | 🐛 6 | 🌐 Ruby | 📅 2026-09-04 — NixOS and ZFS-based host operating system for unprivileged LXC containers.
...
* [Proxmox-GitOps](https://github.com/stevius10/Proxmox-GitOps) ⭐ 581 | 🐛 0 | 🌐 Ruby | 📅 2026-08-30 — GitOps and infrastructure-as-code framework for Proxmox LXC containers.
* [terraform-provider-lxd](https://github.com/terraform-lxd/terraform-provider-lxd) ⭐ 273 | 🐛 9 | 🌐 Go | 📅 2026-09-04 — Manages LXD resources with Terraform or OpenTofu.
* [proxmox-lxc-autoscale](https://github.com/fabriziosalmi/proxmox-lxc-autoscale) ⭐ 257 | 🐛 18 | 🌐 Python | 📅 2026-09-04 — Dynamically adjusts CPU and memory allocations for Proxmox LXC containers.
...
* [colima](https://github.com/abiosoft/colima) ⭐ 30,634 | 🐛 389 | 🌐 Go | 📅 2026-08-31 — Runs Docker, containerd, Kubernetes, or Incus on macOS and Linux with minimal setup.
* [crabbox](https://github.com/openclaw/crabbox) ⭐ 1,364 | 🐛 40 | 🌐 Go | 📅 2026-09-04 — Creates Incus-backed SSH leases for remote development and test workloads.
* [code-on-incus](https://github.com/mensfeld/code-on-incus) ⭐ 687 | 🐛 26 | 🌐 Go | 📅 2026-09-04 — Runs isolated development agents with root, systemd, Docker, and network threat controls.
* [garm](https://github.com/cloudbase/garm) ⭐ 393 | 🐛 28 | 🌐 Go | 📅 2026-09-03 and [garm-provider-incus](https://github.com/cloudbase/garm-provider-incus) ⭐ 14 | 🐛 0 | 🌐 Go | 📅 2026-08-29 — Autoscale ephemeral GitHub Actions and Gitea runners on Incus.
...
* [containarium](https://github.com/FootprintAI/Containarium) ⭐ 276 | 🐛 89 | 🌐 Go | 📅 2026-09-04 — Provides SSH-native isolated environments with an LXC backend, eBPF egress controls, and GPU support.
...
* [incus-spawn](https://github.com/Sanne/incus-spawn) ⭐ 37 | 🐛 50 | 🌐 Java | 📅 2026-09-04 — CLI and TUI for disposable Incus development sandboxes.
* [lincubate](https://github.com/popey/lincubate) ⚠️ Archived — Runs development agents in sandboxed LXD containers.

## User Interfaces

* [xpipe](https://github.com/xpipe-io/xpipe) ⭐ 14,488 | 🐛 51 | 🌐 Java | 📅 2026-09-04 — Desktop interface for discovering and accessing local or remote LXD and Incus instances.
...
* [oneclickvirt](https://github.com/oneclickvirt/oneclickvirt) ⭐ 368 | 🐛 1 | 🌐 Go | 📅 2026-08-30 — Multi-hypervisor management panel with Incus and LXD support.
...
* [incus](https://github.com/lxc/incus) ⭐ 6,130 | 🐛 37 | 🌐 Go | 📅 2026-09-04 — Community-led system container and virtual machine manager.
* [lxc](https://github.com/lxc/lxc) ⭐ 5,254 | 🐛 148 | 🌐 C | 📅 2026-08-31 — Linux system container runtime, command-line tools, and `liblxc` library.
* [lxd](https://github.com/canonical/lxd) ⭐ 4,823 | 🐛 433 | 🌐 Go | 📅 2026-09-04 — Canonical's system container and virtual machine manager.
...
* [lxd-imagebuilder](https://github.com/canonical/lxd-imagebuilder) ⭐ 22 | 🐛 8 | 🌐 Go | 📅 2026-09-02 — Builds LXD container and VM images and Simple Streams catalogs.
...
* [lxd-ui](https://github.com/canonical/lxd-ui) ⭐ 494 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-04 — Canonical's official browser interface, included with LXD.
...
* [Migrate LXD to Incus](https://github.com/lxc/incus/blob/stable-7.0/doc/howto/server_migrate_lxd.md) ⭐ 6,130 | 🐛 37 | 🌐 Go | 📅 2026-09-04 — Version-pinned `lxd-to-incus` guide; check its compatibility table before migrating.
...
* [Incus security advisories](https://github.com/lxc/incus/security) ⭐ 6,130 | 🐛 37 | 🌐 Go | 📅 2026-09-04 — Reporting policy and published advisories.
* [LXD security advisories](https://github.com/canonical/lxd/security/advisories) ⭐ 4,823 | 🐛 433 | 🌐 Go | 📅 2026-09-04 — Canonical's published vulnerability record.
