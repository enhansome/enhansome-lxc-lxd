...
* [vpsadminos](https://github.com/vpsfreecz/vpsadminos) ⭐ 184 | 🐛 6 | 🌐 Ruby | 📅 2026-08-20 — NixOS and ZFS-based host operating system for unprivileged LXC containers.
...
* [proxmox-lxc-autoscale](https://github.com/fabriziosalmi/proxmox-lxc-autoscale) ⭐ 255 | 🐛 14 | 🌐 Python | 📅 2026-08-14 — Dynamically adjusts CPU and memory allocations for Proxmox LXC containers.
...
* [colima](https://github.com/abiosoft/colima) ⭐ 30,443 | 🐛 386 | 🌐 Go | 📅 2026-08-17 — Runs Docker, containerd, Kubernetes, or Incus on macOS and Linux with minimal setup.
* [crabbox](https://github.com/openclaw/crabbox) ⭐ 1,322 | 🐛 8 | 🌐 Go | 📅 2026-08-20 — Creates Incus-backed SSH leases for remote development and test workloads.
* [code-on-incus](https://github.com/mensfeld/code-on-incus) ⭐ 656 | 🐛 33 | 🌐 Go | 📅 2026-08-19 — Runs isolated development agents with root, systemd, Docker, and network threat controls.
* [garm](https://github.com/cloudbase/garm) ⭐ 374 | 🐛 25 | 🌐 Go | 📅 2026-08-20 and [garm-provider-incus](https://github.com/cloudbase/garm-provider-incus) ⭐ 14 | 🐛 0 | 🌐 Go | 📅 2026-08-20 — Autoscale ephemeral GitHub Actions and Gitea runners on Incus.
...
* [containarium](https://github.com/FootprintAI/Containarium) ⭐ 273 | 🐛 77 | 🌐 Go | 📅 2026-08-20 — Provides SSH-native isolated environments with an LXC backend, eBPF egress controls, and GPU support.
...
* [incus-spawn](https://github.com/Sanne/incus-spawn) ⭐ 34 | 🐛 43 | 🌐 Java | 📅 2026-08-20 — CLI and TUI for disposable Incus development sandboxes.
* [lincubate](https://github.com/popey/lincubate) ⚠️ Archived — Runs development agents in sandboxed LXD containers.

## User Interfaces

* [xpipe](https://github.com/xpipe-io/xpipe) ⭐ 14,434 | 🐛 64 | 🌐 Java | 📅 2026-08-19 — Desktop interface for discovering and accessing local or remote LXD and Incus instances.
...
* [oneclickvirt](https://github.com/oneclickvirt/oneclickvirt) ⭐ 367 | 🐛 1 | 🌐 Go | 📅 2026-08-20 — Multi-hypervisor management panel with Incus and LXD support.
...
* [incusAutobackup](https://github.com/rbnhln/incusAutobackup) ⭐ 7 | 🐛 12 | 🌐 Go | 📅 2026-08-20 — Replicates Incus instances and volumes between source and target hosts.
...
* [incus](https://github.com/lxc/incus) ⭐ 5,986 | 🐛 39 | 🌐 Go | 📅 2026-08-20 — Community-led system container and virtual machine manager.
* [lxc](https://github.com/lxc/lxc) ⭐ 5,243 | 🐛 151 | 🌐 C | 📅 2026-08-18 — Linux system container runtime, command-line tools, and `liblxc` library.
* [lxd](https://github.com/canonical/lxd) ⭐ 4,816 | 🐛 419 | 🌐 Go | 📅 2026-08-20 — Canonical's system container and virtual machine manager.
* [lxcfs](https://github.com/lxc/lxcfs) ⭐ 1,193 | 🐛 35 | 🌐 C | 📅 2026-05-15 — FUSE filesystem providing container-aware system information.
* [incus-os](https://github.com/lxc/incus-os) ⭐ 1,079 | 🐛 54 | 🌐 Go | 📅 2026-08-19 — Immutable operating system dedicated to running Incus.
* [microcloud](https://github.com/canonical/microcloud) ⭐ 525 | 🐛 51 | 🌐 Go | 📅 2026-08-19 — Automated private cloud built from LXD, Ceph, and OVN.
...
* [distrobuilder](https://github.com/lxc/distrobuilder) ⭐ 868 | 🐛 27 | 🌐 Go | 📅 2026-08-19 — Builds LXC and Incus images from declarative YAML definitions.
* [lxd-imagebuilder](https://github.com/canonical/lxd-imagebuilder) ⭐ 22 | 🐛 2 | 🌐 Go | 📅 2026-08-19 — Builds LXD container and VM images and Simple Streams catalogs.
...
* [lxd-ui](https://github.com/canonical/lxd-ui) ⭐ 491 | 🐛 42 | 🌐 TypeScript | 📅 2026-08-18 — Canonical's official browser interface, included with LXD.
...
* [incus-compose](https://github.com/lxc/incus-compose) ⭐ 55 | 🐛 11 | 🌐 Go | 📅 2026-08-18 — Runs Compose-spec workloads natively on Incus.
* [lxd-csi-driver](https://github.com/canonical/lxd-csi-driver) ⭐ 8 | 🐛 8 | 🌐 Go | 📅 2026-08-19 — Exposes LXD storage to Kubernetes workloads.
...
* [Migrate LXD to Incus](https://github.com/lxc/incus/blob/stable-7.0/doc/howto/server_migrate_lxd.md) ⭐ 5,986 | 🐛 39 | 🌐 Go | 📅 2026-08-20 — Version-pinned `lxd-to-incus` guide; check its compatibility table before migrating.
...
* [Incus security advisories](https://github.com/lxc/incus/security) ⭐ 5,986 | 🐛 39 | 🌐 Go | 📅 2026-08-20 — Reporting policy and published advisories.
* [LXD security advisories](https://github.com/canonical/lxd/security/advisories) ⭐ 4,816 | 🐛 419 | 🌐 Go | 📅 2026-08-20 — Canonical's published vulnerability record.
