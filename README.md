...
* [zabbly/incus](https://github.com/zabbly/incus) ⭐ 548 | 🐛 6 | 🌐 Python | 📅 2026-09-02 — Signed Incus packages for supported Debian and Ubuntu releases.
* [vpsadminos](https://github.com/vpsfreecz/vpsadminos) ⭐ 184 | 🐛 6 | 🌐 Ruby | 📅 2026-09-03 — NixOS and ZFS-based host operating system for unprivileged LXC containers.
...
* [incus-windows](https://github.com/antifob/incus-windows) ⭐ 101 | 🐛 4 | 🌐 PowerShell | 📅 2026-07-21 — Toolset for creating Windows images for Incus virtual machines.
...
* [talos-incus](https://github.com/windsorcli/talos-incus) ⭐ 12 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-03 — Publishes signed Talos Linux VM images through an Incus Simple Streams remote.
...
* [Proxmox-GitOps](https://github.com/stevius10/Proxmox-GitOps) ⭐ 580 | 🐛 0 | 🌐 Ruby | 📅 2026-08-30 — GitOps and infrastructure-as-code framework for Proxmox LXC containers.
* [terraform-provider-lxd](https://github.com/terraform-lxd/terraform-provider-lxd) ⭐ 273 | 🐛 11 | 🌐 Go | 📅 2026-09-02 — Manages LXD resources with Terraform or OpenTofu.
* [proxmox-lxc-autoscale](https://github.com/fabriziosalmi/proxmox-lxc-autoscale) ⭐ 257 | 🐛 18 | 🌐 Python | 📅 2026-08-25 — Dynamically adjusts CPU and memory allocations for Proxmox LXC containers.
...
* [colima](https://github.com/abiosoft/colima) ⭐ 30,621 | 🐛 389 | 🌐 Go | 📅 2026-08-31 — Runs Docker, containerd, Kubernetes, or Incus on macOS and Linux with minimal setup.
* [crabbox](https://github.com/openclaw/crabbox) ⭐ 1,361 | 🐛 40 | 🌐 Go | 📅 2026-09-03 — Creates Incus-backed SSH leases for remote development and test workloads.
* [code-on-incus](https://github.com/mensfeld/code-on-incus) ⭐ 687 | 🐛 24 | 🌐 Go | 📅 2026-09-03 — Runs isolated development agents with root, systemd, Docker, and network threat controls.
* [garm](https://github.com/cloudbase/garm) ⭐ 393 | 🐛 26 | 🌐 Go | 📅 2026-09-03 and [garm-provider-incus](https://github.com/cloudbase/garm-provider-incus) ⭐ 14 | 🐛 0 | 🌐 Go | 📅 2026-08-29 — Autoscale ephemeral GitHub Actions and Gitea runners on Incus.
...
* [containarium](https://github.com/FootprintAI/Containarium) ⭐ 276 | 🐛 89 | 🌐 Go | 📅 2026-09-03 — Provides SSH-native isolated environments with an LXC backend, eBPF egress controls, and GPU support.
...
* [incus-spawn](https://github.com/Sanne/incus-spawn) ⭐ 37 | 🐛 47 | 🌐 Java | 📅 2026-09-03 — CLI and TUI for disposable Incus development sandboxes.
* [lincubate](https://github.com/popey/lincubate) ⚠️ Archived — Runs development agents in sandboxed LXD containers.

## User Interfaces

* [xpipe](https://github.com/xpipe-io/xpipe) ⭐ 14,482 | 🐛 69 | 🌐 Java | 📅 2026-09-03 — Desktop interface for discovering and accessing local or remote LXD and Incus instances.
* [LxdMosaic](https://github.com/turtle0x1/LxdMosaic) ⭐ 613 | 🐛 21 | 🌐 PHP | 📅 2026-09-03 — Web interface for managing multiple LXD and Incus servers.
...
* [oneclickvirt](https://github.com/oneclickvirt/oneclickvirt) ⭐ 367 | 🐛 1 | 🌐 Go | 📅 2026-08-30 — Multi-hypervisor management panel with Incus and LXD support.
...
* [kapsule](https://github.com/KDE/kapsule) ⭐ 22 | 🐛 0 | 🌐 Python | 📅 2026-08-31 — Incus container management with KDE Plasma integration.
...
* [incus](https://github.com/lxc/incus) ⭐ 6,122 | 🐛 34 | 🌐 Go | 📅 2026-09-03 — Community-led system container and virtual machine manager.
* [lxc](https://github.com/lxc/lxc) ⭐ 5,254 | 🐛 148 | 🌐 C | 📅 2026-08-31 — Linux system container runtime, command-line tools, and `liblxc` library.
* [lxd](https://github.com/canonical/lxd) ⭐ 4,821 | 🐛 429 | 🌐 Go | 📅 2026-09-03 — Canonical's system container and virtual machine manager.
* [lxcfs](https://github.com/lxc/lxcfs) ⭐ 1,194 | 🐛 37 | 🌐 C | 📅 2026-05-15 — FUSE filesystem providing container-aware system information.
* [incus-os](https://github.com/lxc/incus-os) ⭐ 1,090 | 🐛 44 | 🌐 Go | 📅 2026-09-03 — Immutable operating system dedicated to running Incus.
* [microcloud](https://github.com/canonical/microcloud) ⭐ 532 | 🐛 58 | 🌐 Go | 📅 2026-09-03 — Automated private cloud built from LXD, Ceph, and OVN.
...
* [distrobuilder](https://github.com/lxc/distrobuilder) ⭐ 869 | 🐛 27 | 🌐 Go | 📅 2026-09-01 — Builds LXC and Incus images from declarative YAML definitions.
* [lxd-imagebuilder](https://github.com/canonical/lxd-imagebuilder) ⭐ 22 | 🐛 6 | 🌐 Go | 📅 2026-09-02 — Builds LXD container and VM images and Simple Streams catalogs.
...
* [lxd-ui](https://github.com/canonical/lxd-ui) ⭐ 493 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-03 — Canonical's official browser interface, included with LXD.
...
* [terraform-provider-incus](https://github.com/lxc/terraform-provider-incus) ⭐ 211 | 🐛 16 | 🌐 Go | 📅 2026-08-31 — Manages Incus instances, projects, profiles, networks, and storage.
* [incus-deploy](https://github.com/lxc/incus-deploy) ⭐ 157 | 🐛 12 | 🌐 HCL | 📅 2026-05-26 — Ansible, Terraform, and scripts for deploying Incus clusters with Ceph and OVN.
* [cluster-api-provider-incus](https://github.com/lxc/cluster-api-provider-incus) ⭐ 116 | 🐛 7 | 🌐 Go | 📅 2026-06-28 — Provisions Kubernetes clusters on Incus, LXD, and MicroCloud.
* [incus-compose](https://github.com/lxc/incus-compose) ⭐ 72 | 🐛 7 | 🌐 Go | 📅 2026-09-01 — Runs Compose-spec workloads natively on Incus.
...
* [Migrate LXD to Incus](https://github.com/lxc/incus/blob/stable-7.0/doc/howto/server_migrate_lxd.md) ⭐ 6,122 | 🐛 34 | 🌐 Go | 📅 2026-09-03 — Version-pinned `lxd-to-incus` guide; check its compatibility table before migrating.
...
* [Incus security advisories](https://github.com/lxc/incus/security) ⭐ 6,122 | 🐛 34 | 🌐 Go | 📅 2026-09-03 — Reporting policy and published advisories.
* [LXD security advisories](https://github.com/canonical/lxd/security/advisories) ⭐ 4,821 | 🐛 429 | 🌐 Go | 📅 2026-09-03 — Canonical's published vulnerability record.
