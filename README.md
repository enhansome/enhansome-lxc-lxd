...
* [vpsadminos](https://github.com/vpsfreecz/vpsadminos) ⭐ 184 | 🐛 7 | 🌐 Ruby | 📅 2026-09-24 — NixOS and ZFS-based host operating system for unprivileged LXC containers.
...
* [talos-incus](https://github.com/windsorcli/talos-incus) ⭐ 13 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-24 — Publishes signed Talos Linux VM images through an Incus Simple Streams remote.
...
* [Proxmox-GitOps](https://github.com/stevius10/Proxmox-GitOps) ⭐ 589 | 🐛 2 | 🌐 Ruby | 📅 2026-09-24 — GitOps and infrastructure-as-code framework for Proxmox LXC containers.
...
* [packer-plugin-lxc](https://github.com/hashicorp/packer-plugin-lxc) ⭐ 7 | 🐛 9 | 🌐 Go | 📅 2026-09-24 — Builds native LXC container images with Packer.
...
* [colima](https://github.com/abiosoft/colima) ⭐ 30,971 | 🐛 394 | 🌐 Go | 📅 2026-09-23 — Runs Docker, containerd, Kubernetes, or Incus on macOS and Linux with minimal setup.
* [crabbox](https://github.com/openclaw/crabbox) ⭐ 1,429 | 🐛 16 | 🌐 Go | 📅 2026-09-24 — Creates Incus-backed SSH leases for remote development and test workloads.
* [code-on-incus](https://github.com/mensfeld/code-on-incus) ⭐ 728 | 🐛 26 | 🌐 Go | 📅 2026-09-24 — Runs isolated development agents with root, systemd, Docker, and network threat controls.
* [garm](https://github.com/cloudbase/garm) ⭐ 407 | 🐛 22 | 🌐 Go | 📅 2026-09-24 and [garm-provider-incus](https://github.com/cloudbase/garm-provider-incus) ⭐ 15 | 🐛 0 | 🌐 Go | 📅 2026-09-10 — Autoscale ephemeral GitHub Actions and Gitea runners on Incus.
...
* [containarium](https://github.com/FootprintAI/Containarium) ⭐ 286 | 🐛 70 | 🌐 Go | 📅 2026-09-24 — Provides SSH-native isolated environments with an LXC backend, eBPF egress controls, and GPU support.
...
* [incant](https://github.com/lnussbaum/incant) ⭐ 87 | 🐛 9 | 🌐 Python | 📅 2026-07-20 — Defines reproducible Incus development environments in YAML.
...
* [incus-spawn](https://github.com/Sanne/incus-spawn) ⭐ 40 | 🐛 50 | 🌐 Java | 📅 2026-09-24 — CLI and TUI for disposable Incus development sandboxes.
* [lincubate](https://github.com/popey/lincubate) ⚠️ Archived — Runs development agents in sandboxed LXD containers.

## User Interfaces

* [xpipe](https://github.com/xpipe-io/xpipe) ⭐ 14,557 | 🐛 60 | 🌐 Java | 📅 2026-09-24 — Desktop interface for discovering and accessing local or remote LXD and Incus instances.
...
* [oneclickvirt](https://github.com/oneclickvirt/oneclickvirt) ⭐ 371 | 🐛 1 | 🌐 Go | 📅 2026-09-24 — Multi-hypervisor management panel with Incus and LXD support.
* [incus-ui-canonical](https://github.com/zabbly/incus-ui-canonical) ⭐ 119 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-15 — Frequently rebased Incus-compatible fork of Canonical's LXD UI.
* [ararat-web](https://github.com/hyecompany/ararat-web) ⭐ 43 | 🐛 19 | 🌐 TypeScript | 📅 2026-07-25 — Incus-native web control plane currently in public beta.
* [kapsule](https://github.com/KDE/kapsule) ⭐ 23 | 🐛 0 | 🌐 Python | 📅 2026-08-31 — Incus container management with KDE Plasma integration.

## Operations

* [incusAutobackup](https://github.com/rbnhln/incusAutobackup) ⭐ 8 | 🐛 13 | 🌐 Go | 📅 2026-09-24 — Replicates Incus instances and volumes between source and target hosts.
...
* [incus](https://github.com/lxc/incus) ⭐ 6,242 | 🐛 32 | 🌐 Go | 📅 2026-09-24 — Community-led system container and virtual machine manager.
* [lxc](https://github.com/lxc/lxc) ⭐ 5,264 | 🐛 151 | 🌐 C | 📅 2026-09-07 — Linux system container runtime, command-line tools, and `liblxc` library.
* [lxd](https://github.com/canonical/lxd) ⭐ 4,831 | 🐛 424 | 🌐 Go | 📅 2026-09-23 — Canonical's system container and virtual machine manager.
* [lxcfs](https://github.com/lxc/lxcfs) ⭐ 1,196 | 🐛 38 | 🌐 C | 📅 2026-05-15 — FUSE filesystem providing container-aware system information.
* [incus-os](https://github.com/lxc/incus-os) ⭐ 1,118 | 🐛 50 | 🌐 Go | 📅 2026-09-23 — Immutable operating system dedicated to running Incus.
* [microcloud](https://github.com/canonical/microcloud) ⭐ 536 | 🐛 60 | 🌐 Go | 📅 2026-09-24 — Automated private cloud built from LXD, Ceph, and OVN.
...
* [lxd-ui](https://github.com/canonical/lxd-ui) ⭐ 495 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-24 — Canonical's official browser interface, included with LXD.
...
* [Migrate LXD to Incus](https://github.com/lxc/incus/blob/stable-7.0/doc/howto/server_migrate_lxd.md) ⭐ 6,242 | 🐛 32 | 🌐 Go | 📅 2026-09-24 — Version-pinned `lxd-to-incus` guide; check its compatibility table before migrating.
...
* [Incus security advisories](https://github.com/lxc/incus/security) ⭐ 6,242 | 🐛 32 | 🌐 Go | 📅 2026-09-24 — Reporting policy and published advisories.
* [LXD security advisories](https://github.com/canonical/lxd/security/advisories) ⭐ 4,831 | 🐛 424 | 🌐 Go | 📅 2026-09-23 — Canonical's published vulnerability record.
