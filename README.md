...
* [vpsadminos](https://github.com/vpsfreecz/vpsadminos) ⭐ 184 | 🐛 6 | 🌐 Ruby | 📅 2026-09-14 — NixOS and ZFS-based host operating system for unprivileged LXC containers.
...
* [Proxmox-GitOps](https://github.com/stevius10/Proxmox-GitOps) ⭐ 583 | 🐛 1 | 🌐 Ruby | 📅 2026-09-12 — GitOps and infrastructure-as-code framework for Proxmox LXC containers.
* [terraform-provider-lxd](https://github.com/terraform-lxd/terraform-provider-lxd) ⭐ 273 | 🐛 7 | 🌐 Go | 📅 2026-09-14 — Manages LXD resources with Terraform or OpenTofu.
* [proxmox-lxc-autoscale](https://github.com/fabriziosalmi/proxmox-lxc-autoscale) ⭐ 259 | 🐛 15 | 🌐 Python | 📅 2026-09-07 — Dynamically adjusts CPU and memory allocations for Proxmox LXC containers.
...
* [colima](https://github.com/abiosoft/colima) ⭐ 30,803 | 🐛 398 | 🌐 Go | 📅 2026-09-11 — Runs Docker, containerd, Kubernetes, or Incus on macOS and Linux with minimal setup.
* [crabbox](https://github.com/openclaw/crabbox) ⭐ 1,395 | 🐛 39 | 🌐 Go | 📅 2026-09-14 — Creates Incus-backed SSH leases for remote development and test workloads.
* [code-on-incus](https://github.com/mensfeld/code-on-incus) ⭐ 703 | 🐛 24 | 🌐 Go | 📅 2026-09-14 — Runs isolated development agents with root, systemd, Docker, and network threat controls.
* [garm](https://github.com/cloudbase/garm) ⭐ 403 | 🐛 22 | 🌐 Go | 📅 2026-09-14 and [garm-provider-incus](https://github.com/cloudbase/garm-provider-incus) ⭐ 14 | 🐛 0 | 🌐 Go | 📅 2026-09-10 — Autoscale ephemeral GitHub Actions and Gitea runners on Incus.
...
* [containarium](https://github.com/FootprintAI/Containarium) ⭐ 278 | 🐛 98 | 🌐 Go | 📅 2026-09-14 — Provides SSH-native isolated environments with an LXC backend, eBPF egress controls, and GPU support.
...
* [incus-spawn](https://github.com/Sanne/incus-spawn) ⭐ 38 | 🐛 55 | 🌐 Java | 📅 2026-09-14 — CLI and TUI for disposable Incus development sandboxes.
* [lincubate](https://github.com/popey/lincubate) ⚠️ Archived — Runs development agents in sandboxed LXD containers.

## User Interfaces

* [xpipe](https://github.com/xpipe-io/xpipe) ⭐ 14,531 | 🐛 59 | 🌐 Java | 📅 2026-09-14 — Desktop interface for discovering and accessing local or remote LXD and Incus instances.
...
* [incus-ui-canonical](https://github.com/zabbly/incus-ui-canonical) ⭐ 118 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-08 — Frequently rebased Incus-compatible fork of Canonical's LXD UI.
...
* [incus](https://github.com/lxc/incus) ⭐ 6,182 | 🐛 40 | 🌐 Go | 📅 2026-09-14 — Community-led system container and virtual machine manager.
* [lxc](https://github.com/lxc/lxc) ⭐ 5,261 | 🐛 148 | 🌐 C | 📅 2026-09-07 — Linux system container runtime, command-line tools, and `liblxc` library.
* [lxd](https://github.com/canonical/lxd) ⭐ 4,826 | 🐛 423 | 🌐 Go | 📅 2026-09-14 — Canonical's system container and virtual machine manager.
* [lxcfs](https://github.com/lxc/lxcfs) ⭐ 1,194 | 🐛 38 | 🌐 C | 📅 2026-05-15 — FUSE filesystem providing container-aware system information.
* [incus-os](https://github.com/lxc/incus-os) ⭐ 1,100 | 🐛 49 | 🌐 Go | 📅 2026-09-14 — Immutable operating system dedicated to running Incus.
...
* [lxd-imagebuilder](https://github.com/canonical/lxd-imagebuilder) ⭐ 23 | 🐛 0 | 🌐 Go | 📅 2026-09-11 — Builds LXD container and VM images and Simple Streams catalogs.
...
* [lxd-ui](https://github.com/canonical/lxd-ui) ⭐ 495 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-14 — Canonical's official browser interface, included with LXD.
...
* [incus-compose](https://github.com/lxc/incus-compose) ⭐ 78 | 🐛 8 | 🌐 Go | 📅 2026-09-14 — Runs Compose-spec workloads natively on Incus.
* [python3-lxc](https://github.com/lxc/python3-lxc) ⭐ 68 | 🐛 9 | 🌐 C | 📅 2026-08-20 — Python 3 bindings for `liblxc`.
* [lxd-csi-driver](https://github.com/canonical/lxd-csi-driver) ⭐ 9 | 🐛 9 | 🌐 Go | 📅 2026-09-08 — Exposes LXD storage to Kubernetes workloads.
...
* [Migrate LXD to Incus](https://github.com/lxc/incus/blob/stable-7.0/doc/howto/server_migrate_lxd.md) ⭐ 6,182 | 🐛 40 | 🌐 Go | 📅 2026-09-14 — Version-pinned `lxd-to-incus` guide; check its compatibility table before migrating.
...
* [Incus security advisories](https://github.com/lxc/incus/security) ⭐ 6,182 | 🐛 40 | 🌐 Go | 📅 2026-09-14 — Reporting policy and published advisories.
* [LXD security advisories](https://github.com/canonical/lxd/security/advisories) ⭐ 4,826 | 🐛 423 | 🌐 Go | 📅 2026-09-14 — Canonical's published vulnerability record.
