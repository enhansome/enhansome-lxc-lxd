...
* [zabbly/incus](https://github.com/zabbly/incus) ⭐ 555 | 🐛 6 | 🌐 Python | 📅 2026-09-14 — Signed Incus packages for supported Debian and Ubuntu releases.
* [vpsadminos](https://github.com/vpsfreecz/vpsadminos) ⭐ 184 | 🐛 7 | 🌐 Ruby | 📅 2026-09-22 — NixOS and ZFS-based host operating system for unprivileged LXC containers.
...
* [Proxmox-GitOps](https://github.com/stevius10/Proxmox-GitOps) ⭐ 588 | 🐛 1 | 🌐 Ruby | 📅 2026-09-12 — GitOps and infrastructure-as-code framework for Proxmox LXC containers.
* [terraform-provider-lxd](https://github.com/terraform-lxd/terraform-provider-lxd) ⭐ 273 | 🐛 6 | 🌐 Go | 📅 2026-09-21 — Manages LXD resources with Terraform or OpenTofu.
...
* [incus-apply](https://github.com/abiosoft/incus-apply) ⭐ 37 | 🐛 7 | 🌐 Go | 📅 2026-06-15 — Declarative configuration management for Incus resources.
...
* [packer-plugin-lxd](https://github.com/hashicorp/packer-plugin-lxd) ⭐ 14 | 🐛 9 | 🌐 Go | 📅 2026-09-22 — Builds reusable LXD images with Packer provisioners.
* [packer-plugin-lxc](https://github.com/hashicorp/packer-plugin-lxc) ⭐ 7 | 🐛 10 | 🌐 Go | 📅 2026-09-22 — Builds native LXC container images with Packer.
...
* [colima](https://github.com/abiosoft/colima) ⭐ 30,941 | 🐛 395 | 🌐 Go | 📅 2026-09-19 — Runs Docker, containerd, Kubernetes, or Incus on macOS and Linux with minimal setup.
* [crabbox](https://github.com/openclaw/crabbox) ⭐ 1,417 | 🐛 25 | 🌐 Go | 📅 2026-09-22 — Creates Incus-backed SSH leases for remote development and test workloads.
* [code-on-incus](https://github.com/mensfeld/code-on-incus) ⭐ 727 | 🐛 23 | 🌐 Go | 📅 2026-09-22 — Runs isolated development agents with root, systemd, Docker, and network threat controls.
* [garm](https://github.com/cloudbase/garm) ⭐ 406 | 🐛 21 | 🌐 Go | 📅 2026-09-21 and [garm-provider-incus](https://github.com/cloudbase/garm-provider-incus) ⭐ 14 | 🐛 0 | 🌐 Go | 📅 2026-09-10 — Autoscale ephemeral GitHub Actions and Gitea runners on Incus.
...
* [containarium](https://github.com/FootprintAI/Containarium) ⭐ 283 | 🐛 73 | 🌐 Go | 📅 2026-09-22 — Provides SSH-native isolated environments with an LXC backend, eBPF egress controls, and GPU support.
...
* [incus-spawn](https://github.com/Sanne/incus-spawn) ⭐ 39 | 🐛 49 | 🌐 Java | 📅 2026-09-22 — CLI and TUI for disposable Incus development sandboxes.
* [lincubate](https://github.com/popey/lincubate) ⚠️ Archived — Runs development agents in sandboxed LXD containers.

## User Interfaces

* [xpipe](https://github.com/xpipe-io/xpipe) ⭐ 14,551 | 🐛 60 | 🌐 Java | 📅 2026-09-21 — Desktop interface for discovering and accessing local or remote LXD and Incus instances.
...
* [oneclickvirt](https://github.com/oneclickvirt/oneclickvirt) ⭐ 371 | 🐛 1 | 🌐 Go | 📅 2026-09-22 — Multi-hypervisor management panel with Incus and LXD support.
...
* [incus](https://github.com/lxc/incus) ⭐ 6,226 | 🐛 47 | 🌐 Go | 📅 2026-09-21 — Community-led system container and virtual machine manager.
* [lxc](https://github.com/lxc/lxc) ⭐ 5,263 | 🐛 151 | 🌐 C | 📅 2026-09-07 — Linux system container runtime, command-line tools, and `liblxc` library.
* [lxd](https://github.com/canonical/lxd) ⭐ 4,832 | 🐛 429 | 🌐 Go | 📅 2026-09-22 — Canonical's system container and virtual machine manager.
* [lxcfs](https://github.com/lxc/lxcfs) ⭐ 1,196 | 🐛 38 | 🌐 C | 📅 2026-05-15 — FUSE filesystem providing container-aware system information.
* [incus-os](https://github.com/lxc/incus-os) ⭐ 1,112 | 🐛 48 | 🌐 Go | 📅 2026-09-18 — Immutable operating system dedicated to running Incus.
* [microcloud](https://github.com/canonical/microcloud) ⭐ 536 | 🐛 61 | 🌐 Go | 📅 2026-09-17 — Automated private cloud built from LXD, Ceph, and OVN.
...
* [distrobuilder](https://github.com/lxc/distrobuilder) ⭐ 874 | 🐛 27 | 🌐 Go | 📅 2026-09-21 — Builds LXC and Incus images from declarative YAML definitions.
* [lxd-imagebuilder](https://github.com/canonical/lxd-imagebuilder) ⭐ 23 | 🐛 1 | 🌐 Go | 📅 2026-09-21 — Builds LXD container and VM images and Simple Streams catalogs.
...
* [lxd-ui](https://github.com/canonical/lxd-ui) ⭐ 495 | 🐛 41 | 🌐 TypeScript | 📅 2026-09-22 — Canonical's official browser interface, included with LXD.
...
* [terraform-provider-incus](https://github.com/lxc/terraform-provider-incus) ⭐ 215 | 🐛 13 | 🌐 Go | 📅 2026-09-19 — Manages Incus instances, projects, profiles, networks, and storage.
...
* [incus-compose](https://github.com/lxc/incus-compose) ⭐ 80 | 🐛 6 | 🌐 Go | 📅 2026-09-22 — Runs Compose-spec workloads natively on Incus.
* [python3-lxc](https://github.com/lxc/python3-lxc) ⭐ 68 | 🐛 9 | 🌐 C | 📅 2026-08-20 — Python 3 bindings for `liblxc`.
* [lxd-csi-driver](https://github.com/canonical/lxd-csi-driver) ⭐ 9 | 🐛 8 | 🌐 Go | 📅 2026-09-22 — Exposes LXD storage to Kubernetes workloads.
...
* [Migrate LXD to Incus](https://github.com/lxc/incus/blob/stable-7.0/doc/howto/server_migrate_lxd.md) ⭐ 6,226 | 🐛 47 | 🌐 Go | 📅 2026-09-21 — Version-pinned `lxd-to-incus` guide; check its compatibility table before migrating.
...
* [Incus security advisories](https://github.com/lxc/incus/security) ⭐ 6,226 | 🐛 47 | 🌐 Go | 📅 2026-09-21 — Reporting policy and published advisories.
* [LXD security advisories](https://github.com/canonical/lxd/security/advisories) ⭐ 4,832 | 🐛 429 | 🌐 Go | 📅 2026-09-22 — Canonical's published vulnerability record.
